...
namespace MissionPlanner.GCSViews
{
    public partial class FlightData : MyUserControl, IActivate, IDeactivate
    {
        ...
        private AGaugeApp.AGauge Gbattery;
        ...
        public FlightData()
        {
            ...
            */
            ...
            // Battery voltage gauge (programmatic — avoids Designer file changes)
            Gbattery = new AGaugeApp.AGauge();
            Gbattery.BackColor = Color.Transparent;
            Gbattery.BaseArcColor = Color.Transparent;
            Gbattery.BaseArcRadius = 70;
            Gbattery.BaseArcStart = 135;
            Gbattery.BaseArcSweep = 270;
            Gbattery.BaseArcWidth = 2;
            Gbattery.Cap_Idx = 0;
            Gbattery.CapColor = Color.White;
            Gbattery.CapPosition = new Point(58, 85);
            Gbattery.CapText = "Volt";
            Gbattery.CapColors = new Color[] { Color.White, Color.White, Color.Black, Color.Black, Color.Black };
            Gbattery.CapsPosition = new Point[] { new Point(58, 85), new Point(50, 50), new Point(10, 10), new Point(10, 10), new Point(10, 10) };
            Gbattery.CapsText = new string[] { "Volt", "", "", "", "" };
            Gbattery.Center = new Point(75, 75);
            Gbattery.MaxValue = 30F;
            Gbattery.MinValue = 0F;
            Gbattery.Need_Idx = 3;
            Gbattery.NeedleColor1 = AGaugeApp.AGauge.NeedleColorEnum.Gray;
            Gbattery.NeedleColor2 = Color.White;
            Gbattery.NeedleEnabled = false;
            Gbattery.NeedleRadius = 70;
            Gbattery.NeedleType = 0;
            Gbattery.NeedleWidth = 2;
            Gbattery.NeedlesColor1 = new AGaugeApp.AGauge.NeedleColorEnum[] { AGaugeApp.AGauge.NeedleColorEnum.Gray, AGaugeApp.AGauge.NeedleColorEnum.Gray, AGaugeApp.AGauge.NeedleColorEnum.Gray, AGaugeApp.AGauge.NeedleColorEnum.Gray };
            Gbattery.NeedlesColor2 = new Color[] { Color.White, Color.White, Color.White, Color.White };
            Gbattery.NeedlesEnabled = new bool[] { true, false, false, false };
            Gbattery.NeedlesRadius = new int[] { 50, 50, 70, 70 };
            Gbattery.NeedlesType = new int[] { 0, 0, 0, 0 };
            Gbattery.NeedlesWidth = new int[] { 2, 2, 2, 2 };
            Gbattery.Range_Idx = 0;
            Gbattery.RangeColor = Color.Red;
            Gbattery.RangeEnabled = true;
            Gbattery.RangeStartValue = 0F;
            Gbattery.RangeEndValue = 11.1F;
            Gbattery.RangeInnerRadius = 1;
            Gbattery.RangeOuterRadius = 70;
            Gbattery.RangesColor = new Color[] { Color.Red, Color.LightGreen, Color.Transparent, Color.Transparent, Color.Transparent };
            Gbattery.RangesEnabled = new bool[] { true, true, false, false, false };
            Gbattery.RangesStartValue = new float[] { 0F, 11.1F, 0F, 0F, 0F };
            Gbattery.RangesEndValue = new float[] { 11.1F, 30F, 0F, 0F, 0F };
            Gbattery.RangesInnerRadius = new int[] { 1, 1, 1, 1, 1 };
            Gbattery.RangesOuterRadius = new int[] { 70, 70, 70, 70, 70 };
            Gbattery.ScaleLinesInterColor = Color.White;
            Gbattery.ScaleLinesInterInnerRadius = 52;
            Gbattery.ScaleLinesInterOuterRadius = 70;
            Gbattery.ScaleLinesInterWidth = 1;
            Gbattery.ScaleLinesMajorColor = Color.White;
            Gbattery.ScaleLinesMajorInnerRadius = 50;
            Gbattery.ScaleLinesMajorOuterRadius = 70;
            Gbattery.ScaleLinesMajorStepValue = 5F;
            Gbattery.ScaleLinesMajorWidth = 2;
            Gbattery.ScaleLinesMinorColor = Color.White;
            Gbattery.ScaleLinesMinorInnerRadius = 55;
            Gbattery.ScaleLinesMinorNumOf = 4;
            Gbattery.ScaleLinesMinorOuterRadius = 70;
            Gbattery.ScaleLinesMinorWidth = 1;
            Gbattery.ScaleNumbersColor = Color.White;
            Gbattery.ScaleNumbersFormat = "";
            Gbattery.ScaleNumbersRadius = 42;
            Gbattery.ScaleNumbersRotation = 0;
            Gbattery.ScaleNumbersStartScaleLine = 1;
            Gbattery.ScaleNumbersStepScaleLines = 1;
            Gbattery.Size = new Size(150, 150);
            Gbattery.DataBindings.Add(new Binding("Value0", bindingSourceGaugesTab, "battery_voltage", true));
            tabGauges.Controls.Add(Gbattery);
        ...
        private void AutoUndockHUD()
        {
            ...
            if (Screen.AllScreens.Length > 1)
            {
                ...
                dropout.Location = Screen.AllScreens[1].Bounds.Location;
                dropout.WindowState = FormWindowState.Maximized;
            }
            else
            {
                dropout.Size = new Size(800, 800);
        ...
        private void tabPage1_Resize(object sender, EventArgs e)
        {
            ...
            {
                // near-square: 2 gauges top row, 3 bottom row
                Gvspeed.Visible  = true;
                Gbattery.Visible = true;

                myheight = Math.Min(tabGauges.Height / 2, tabGauges.Width / 3);
                ...
                Gbattery.Width = myheight; Gbattery.Height = myheight;

                Gvspeed.Location = new Point(0, 0);
                Gspeed.Location  = new Point(Gvspeed.Right, 0);

                Galt.Location     = new Point(0, Gvspeed.Bottom);
                Gheading.Location = new Point(Galt.Right, Gvspeed.Bottom);
                Gbattery.Location = new Point(Gheading.Right, Gvspeed.Bottom);
            ...
            else
            {
                Gvspeed.Visible  = true;
                Gbattery.Visible = true;
                mywidth = Math.Min(tabGauges.Width / 5, tabGauges.Height);

                Gvspeed.Width   = mywidth; Gvspeed.Height   = mywidth;
                Gspeed.Width    = mywidth; Gspeed.Height    = mywidth;
                Galt.Width      = mywidth; Galt.Height      = mywidth;
                Gheading.Width  = mywidth; Gheading.Height  = mywidth;
                Gbattery.Width  = mywidth; Gbattery.Height  = mywidth;
            ...
            Gbattery.Location = new Point(Gheading.Right, 0);
        }
