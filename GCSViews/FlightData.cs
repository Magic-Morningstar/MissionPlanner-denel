...
namespace MissionPlanner.GCSViews
{
    public partial class FlightData : MyUserControl, IActivate, IDeactivate
    {
        ...
        private AGaugeApp.AGauge Gwpdist;
        private AGaugeApp.AGauge GdistHome;
        private AGaugeApp.AGauge GbattRemaining;
        ...
        public FlightData()
        {
            ...
            */
            ...
            // WP Distance gauge
            Gwpdist = new AGaugeApp.AGauge();
            Gwpdist.BackColor = Color.Transparent;
            Gwpdist.BaseArcColor = Color.Transparent;
            Gwpdist.BaseArcRadius = 70;
            Gwpdist.BaseArcStart = 135;
            Gwpdist.BaseArcSweep = 270;
            Gwpdist.BaseArcWidth = 2;
            Gwpdist.Cap_Idx = 0;
            Gwpdist.CapColor = Color.White;
            Gwpdist.CapPosition = new Point(50, 85);
            Gwpdist.CapText = "WP Dist";
            Gwpdist.CapColors = new Color[] { Color.White, Color.White, Color.Black, Color.Black, Color.Black };
            Gwpdist.CapsPosition = new Point[] { new Point(50, 85), new Point(50, 50), new Point(10, 10), new Point(10, 10), new Point(10, 10) };
            Gwpdist.CapsText = new string[] { "WP Dist", "", "", "", "" };
            Gwpdist.Center = new Point(75, 75);
            Gwpdist.MaxValue = 1000F;
            Gwpdist.MinValue = 0F;
            Gwpdist.Need_Idx = 3;
            Gwpdist.NeedleColor1 = AGaugeApp.AGauge.NeedleColorEnum.Gray;
            Gwpdist.NeedleColor2 = Color.White;
            Gwpdist.NeedleEnabled = false;
            Gwpdist.NeedleRadius = 70;
            Gwpdist.NeedleType = 0;
            Gwpdist.NeedleWidth = 2;
            Gwpdist.NeedlesColor1 = new AGaugeApp.AGauge.NeedleColorEnum[] { AGaugeApp.AGauge.NeedleColorEnum.Gray, AGaugeApp.AGauge.NeedleColorEnum.Gray, AGaugeApp.AGauge.NeedleColorEnum.Gray, AGaugeApp.AGauge.NeedleColorEnum.Gray };
            Gwpdist.NeedlesColor2 = new Color[] { Color.White, Color.White, Color.White, Color.White };
            Gwpdist.NeedlesEnabled = new bool[] { true, false, false, false };
            Gwpdist.NeedlesRadius = new int[] { 50, 50, 70, 70 };
            Gwpdist.NeedlesType = new int[] { 0, 0, 0, 0 };
            Gwpdist.NeedlesWidth = new int[] { 2, 2, 2, 2 };
            Gwpdist.Range_Idx = 0;
            Gwpdist.RangeColor = Color.Transparent;
            Gwpdist.RangeEnabled = false;
            Gwpdist.RangeStartValue = 0F;
            Gwpdist.RangeEndValue = 1000F;
            Gwpdist.RangeInnerRadius = 1;
            Gwpdist.RangeOuterRadius = 70;
            Gwpdist.RangesColor = new Color[] { Color.Transparent, Color.Transparent, Color.Transparent, Color.Transparent, Color.Transparent };
            Gwpdist.RangesEnabled = new bool[] { false, false, false, false, false };
            Gwpdist.RangesStartValue = new float[] { 0F, 0F, 0F, 0F, 0F };
            Gwpdist.RangesEndValue = new float[] { 1000F, 0F, 0F, 0F, 0F };
            Gwpdist.RangesInnerRadius = new int[] { 1, 1, 1, 1, 1 };
            Gwpdist.RangesOuterRadius = new int[] { 70, 70, 70, 70, 70 };
            Gwpdist.ScaleLinesInterColor = Color.White;
            Gwpdist.ScaleLinesInterInnerRadius = 52;
            Gwpdist.ScaleLinesInterOuterRadius = 60;
            Gwpdist.ScaleLinesInterWidth = 1;
            Gwpdist.ScaleLinesMajorColor = Color.White;
            Gwpdist.ScaleLinesMajorInnerRadius = 50;
            Gwpdist.ScaleLinesMajorOuterRadius = 60;
            Gwpdist.ScaleLinesMajorStepValue = 100F;
            Gwpdist.ScaleLinesMajorWidth = 2;
            Gwpdist.ScaleLinesMinorColor = Color.White;
            Gwpdist.ScaleLinesMinorInnerRadius = 55;
            Gwpdist.ScaleLinesMinorNumOf = 4;
            Gwpdist.ScaleLinesMinorOuterRadius = 60;
            Gwpdist.ScaleLinesMinorWidth = 1;
            Gwpdist.ScaleNumbersColor = Color.White;
            Gwpdist.ScaleNumbersFormat = "";
            Gwpdist.ScaleNumbersRadius = 42;
            Gwpdist.ScaleNumbersRotation = 0;
            Gwpdist.ScaleNumbersStartScaleLine = 1;
            Gwpdist.ScaleNumbersStepScaleLines = 2;
            Gwpdist.Size = new Size(150, 150);
            Gwpdist.DataBindings.Add(new Binding("Value0", bindingSourceGaugesTab, "wp_dist", true));
            tabGauges.Controls.Add(Gwpdist);

            // Distance to home gauge
            GdistHome = new AGaugeApp.AGauge();
            GdistHome.BackColor = Color.Transparent;
            GdistHome.BaseArcColor = Color.Transparent;
            GdistHome.BaseArcRadius = 70;
            GdistHome.BaseArcStart = 135;
            GdistHome.BaseArcSweep = 270;
            GdistHome.BaseArcWidth = 2;
            GdistHome.Cap_Idx = 0;
            GdistHome.CapColor = Color.White;
            GdistHome.CapPosition = new Point(55, 85);
            GdistHome.CapText = "Home";
            GdistHome.CapColors = new Color[] { Color.White, Color.White, Color.Black, Color.Black, Color.Black };
            GdistHome.CapsPosition = new Point[] { new Point(55, 85), new Point(50, 50), new Point(10, 10), new Point(10, 10), new Point(10, 10) };
            GdistHome.CapsText = new string[] { "Home", "", "", "", "" };
            GdistHome.Center = new Point(75, 75);
            GdistHome.MaxValue = 2000F;
            GdistHome.MinValue = 0F;
            GdistHome.Need_Idx = 3;
            GdistHome.NeedleColor1 = AGaugeApp.AGauge.NeedleColorEnum.Gray;
            GdistHome.NeedleColor2 = Color.White;
            GdistHome.NeedleEnabled = false;
            GdistHome.NeedleRadius = 70;
            GdistHome.NeedleType = 0;
            GdistHome.NeedleWidth = 2;
            GdistHome.NeedlesColor1 = new AGaugeApp.AGauge.NeedleColorEnum[] { AGaugeApp.AGauge.NeedleColorEnum.Gray, AGaugeApp.AGauge.NeedleColorEnum.Gray, AGaugeApp.AGauge.NeedleColorEnum.Gray, AGaugeApp.AGauge.NeedleColorEnum.Gray };
            GdistHome.NeedlesColor2 = new Color[] { Color.White, Color.White, Color.White, Color.White };
            GdistHome.NeedlesEnabled = new bool[] { true, false, false, false };
            GdistHome.NeedlesRadius = new int[] { 50, 50, 70, 70 };
            GdistHome.NeedlesType = new int[] { 0, 0, 0, 0 };
            GdistHome.NeedlesWidth = new int[] { 2, 2, 2, 2 };
            GdistHome.Range_Idx = 0;
            GdistHome.RangeColor = Color.Transparent;
            GdistHome.RangeEnabled = false;
            GdistHome.RangeStartValue = 0F;
            GdistHome.RangeEndValue = 500F;
            GdistHome.RangeInnerRadius = 1;
            GdistHome.RangeOuterRadius = 70;
            GdistHome.RangesColor = new Color[] { Color.Transparent, Color.Transparent, Color.Transparent, Color.Transparent, Color.Transparent };
            GdistHome.RangesEnabled = new bool[] { false, false, false, false, false };
            GdistHome.RangesStartValue = new float[] { 0F, 500F, 1000F, 0F, 0F };
            GdistHome.RangesEndValue = new float[] { 500F, 1000F, 2000F, 0F, 0F };
            GdistHome.RangesInnerRadius = new int[] { 1, 1, 1, 1, 1 };
            GdistHome.RangesOuterRadius = new int[] { 70, 70, 70, 70, 70 };
            GdistHome.ScaleLinesInterColor = Color.White;
            GdistHome.ScaleLinesInterInnerRadius = 52;
            GdistHome.ScaleLinesInterOuterRadius = 60;
            GdistHome.ScaleLinesInterWidth = 1;
            GdistHome.ScaleLinesMajorColor = Color.White;
            GdistHome.ScaleLinesMajorInnerRadius = 50;
            GdistHome.ScaleLinesMajorOuterRadius = 60;
            GdistHome.ScaleLinesMajorStepValue = 200F;
            GdistHome.ScaleLinesMajorWidth = 2;
            GdistHome.ScaleLinesMinorColor = Color.White;
            GdistHome.ScaleLinesMinorInnerRadius = 55;
            GdistHome.ScaleLinesMinorNumOf = 4;
            GdistHome.ScaleLinesMinorOuterRadius = 60;
            GdistHome.ScaleLinesMinorWidth = 1;
            GdistHome.ScaleNumbersColor = Color.White;
            GdistHome.ScaleNumbersFormat = "";
            GdistHome.ScaleNumbersRadius = 42;
            GdistHome.ScaleNumbersRotation = 0;
            GdistHome.ScaleNumbersStartScaleLine = 1;
            GdistHome.ScaleNumbersStepScaleLines = 2;
            GdistHome.Size = new Size(150, 150);
            GdistHome.DataBindings.Add(new Binding("Value0", bindingSourceGaugesTab, "DistToHome", true));
            tabGauges.Controls.Add(GdistHome);

            // Battery remaining percentage gauge
            GbattRemaining = new AGaugeApp.AGauge();
            GbattRemaining.BackColor = Color.Transparent;
            GbattRemaining.BaseArcColor = Color.Transparent;
            GbattRemaining.BaseArcRadius = 70;
            GbattRemaining.BaseArcStart = 135;
            GbattRemaining.BaseArcSweep = 270;
            GbattRemaining.BaseArcWidth = 2;
            GbattRemaining.Cap_Idx = 0;
            GbattRemaining.CapColor = Color.White;
            GbattRemaining.CapPosition = new Point(50, 85);
            GbattRemaining.CapText = "Batt %";
            GbattRemaining.CapColors = new Color[] { Color.White, Color.White, Color.Black, Color.Black, Color.Black };
            GbattRemaining.CapsPosition = new Point[] { new Point(50, 85), new Point(50, 50), new Point(10, 10), new Point(10, 10), new Point(10, 10) };
            GbattRemaining.CapsText = new string[] { "Batt %", "", "", "", "" };
            GbattRemaining.Center = new Point(75, 75);
            GbattRemaining.MaxValue = 100F;
            GbattRemaining.MinValue = 0F;
            GbattRemaining.Need_Idx = 3;
            GbattRemaining.NeedleColor1 = AGaugeApp.AGauge.NeedleColorEnum.Gray;
            GbattRemaining.NeedleColor2 = Color.White;
            GbattRemaining.NeedleEnabled = false;
            GbattRemaining.NeedleRadius = 70;
            GbattRemaining.NeedleType = 0;
            GbattRemaining.NeedleWidth = 2;
            GbattRemaining.NeedlesColor1 = new AGaugeApp.AGauge.NeedleColorEnum[] { AGaugeApp.AGauge.NeedleColorEnum.Gray, AGaugeApp.AGauge.NeedleColorEnum.Gray, AGaugeApp.AGauge.NeedleColorEnum.Gray, AGaugeApp.AGauge.NeedleColorEnum.Gray };
            GbattRemaining.NeedlesColor2 = new Color[] { Color.White, Color.White, Color.White, Color.White };
            GbattRemaining.NeedlesEnabled = new bool[] { true, false, false, false };
            GbattRemaining.NeedlesRadius = new int[] { 50, 50, 70, 70 };
            GbattRemaining.NeedlesType = new int[] { 0, 0, 0, 0 };
            GbattRemaining.NeedlesWidth = new int[] { 2, 2, 2, 2 };
            GbattRemaining.Range_Idx = 0;
            GbattRemaining.RangeColor = Color.Transparent;
            GbattRemaining.RangeEnabled = false;
            GbattRemaining.RangeStartValue = 0F;
            GbattRemaining.RangeEndValue = 20F;
            GbattRemaining.RangeInnerRadius = 1;
            GbattRemaining.RangeOuterRadius = 70;
            GbattRemaining.RangesColor = new Color[] { Color.Transparent, Color.Transparent, Color.Transparent, Color.Transparent, Color.Transparent };
            GbattRemaining.RangesEnabled = new bool[] { false, false, false, false, false };
            GbattRemaining.RangesStartValue = new float[] { 0F, 20F, 40F, 0F, 0F };
            GbattRemaining.RangesEndValue = new float[] { 20F, 40F, 100F, 0F, 0F };
            GbattRemaining.RangesInnerRadius = new int[] { 1, 1, 1, 1, 1 };
            GbattRemaining.RangesOuterRadius = new int[] { 70, 70, 70, 70, 70 };
            GbattRemaining.ScaleLinesInterColor = Color.White;
            GbattRemaining.ScaleLinesInterInnerRadius = 52;
            GbattRemaining.ScaleLinesInterOuterRadius = 60;
            GbattRemaining.ScaleLinesInterWidth = 1;
            GbattRemaining.ScaleLinesMajorColor = Color.White;
            GbattRemaining.ScaleLinesMajorInnerRadius = 50;
            GbattRemaining.ScaleLinesMajorOuterRadius = 60;
            GbattRemaining.ScaleLinesMajorStepValue = 10F;
            GbattRemaining.ScaleLinesMajorWidth = 2;
            GbattRemaining.ScaleLinesMinorColor = Color.White;
            GbattRemaining.ScaleLinesMinorInnerRadius = 55;
            GbattRemaining.ScaleLinesMinorNumOf = 4;
            GbattRemaining.ScaleLinesMinorOuterRadius = 60;
            GbattRemaining.ScaleLinesMinorWidth = 1;
            GbattRemaining.ScaleNumbersColor = Color.White;
            GbattRemaining.ScaleNumbersFormat = "";
            GbattRemaining.ScaleNumbersRadius = 42;
            GbattRemaining.ScaleNumbersRotation = 0;
            GbattRemaining.ScaleNumbersStartScaleLine = 1;
            GbattRemaining.ScaleNumbersStepScaleLines = 2;
            GbattRemaining.Size = new Size(150, 150);
            GbattRemaining.DataBindings.Add(new Binding("Value0", bindingSourceGaugesTab, "battery_remaining", true));
            tabGauges.Controls.Add(GbattRemaining);
            ...
            // Remove embedded JPEG gauge face images and apply dark theme background
            Galt.BackgroundImage     = null;
            Gspeed.BackgroundImage   = null;
        ...
        private void tabPage1_Resize(object sender, EventArgs e)
        {
            ...
            {
                // Near-square: 4 top row + 3 bottom row
                Gvspeed.Visible = true;
                Gwpdist.Visible = true; GdistHome.Visible = true; GbattRemaining.Visible = true;

                myheight = Math.Min(tabGauges.Height / 2, tabGauges.Width / 4);

                Gvspeed.Size = Gspeed.Size = Galt.Size = Gheading.Size = new Size(myheight, myheight);
                Gwpdist.Size = GdistHome.Size = GbattRemaining.Size = new Size(myheight, myheight);
                ...
                Gwpdist.Location       = new Point(0, myheight);
                GdistHome.Location     = new Point(Gwpdist.Right, myheight);
                GbattRemaining.Location = new Point(GdistHome.Right, myheight);
            ...
            if (tabGauges.Width < 500)
            {
                ...
                Gwpdist.Visible = false; GdistHome.Visible = false; GbattRemaining.Visible = false;
                mywidth = Math.Min(tabGauges.Width / 3, tabGauges.Height);

                Gspeed.Size   = new Size(mywidth, mywidth);
                Galt.Size     = new Size(mywidth, mywidth);
                Gheading.Size = new Size(mywidth, mywidth);
            ...
            else
            {
                Gvspeed.Visible = true;
                Gwpdist.Visible = true; GdistHome.Visible = true; GbattRemaining.Visible = true;
                mywidth = Math.Min(tabGauges.Width / 7, tabGauges.Height);

                Gvspeed.Size = Gspeed.Size = Galt.Size = Gheading.Size = new Size(mywidth, mywidth);
                Gwpdist.Size = GdistHome.Size = GbattRemaining.Size = new Size(mywidth, mywidth);

                Gvspeed.Location       = new Point(0, 0);
                Gspeed.Location        = new Point(Gvspeed.Right, 0);
                Galt.Location          = new Point(Gspeed.Right, 0);
                Gheading.Location      = new Point(Galt.Right, 0);
                Gwpdist.Location       = new Point(Gheading.Right, 0);
                GdistHome.Location     = new Point(Gwpdist.Right, 0);
                GbattRemaining.Location = new Point(GdistHome.Right, 0);
            }
        }
