...
CONFIG = MenuConfig(
    ...
    # Start on the first active menu.
    ...
    menus=(
       ...
       Menu(
            id="tracking_laser",
            bit=2,
            title="Tracking / Laser",
            short_title="TRACK/LASER",
            bindings=(
                # BUTTON 1
                _f("laser_on_off", "laser on and off"),
        ...
        # to add a new menu for future use
        # Menu(
        #     id="new_menu",
        #     bit=3,
        #     title="New Menu",
        ...
        #     bindings=(
        #         # Physical Button 1
        #         _f("function_1", "Function 1"),   # ▲
        #         _f("function_2", "Function 2"),   # ▼

        #         # Physical Button 2
        #         _f("function_3", "Function 3"),   # ▲
        #         _f("function_4", "Function 4"),   # ▼

        #         # Physical Button 3
        #         _f("function_5", "Function 5"),   # ▲
        #         _f("function_6", "Function 6"),   # ▼
        #     ),
        # ),
