...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        public MainV2()
        {
            ...
            int darkMode = 1;
            NativeMethods.DwmSetWindowAttribute(this.Handle, NativeMethods.DWMWA_USE_IMMERSIVE_DARK_MODE,
        ...
        private void MenuArduPilot_Click(object sender, EventArgs e)
        {
            try
            {
                System.Diagnostics.Process.Start("http://www.denelaeronautics.co.za/");
            }
            catch
            {
                CustomMessageBox.Show("Failed to open url http://www.denelaeronautics.co.za/");
            }
        }
